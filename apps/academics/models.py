...
class HousePoints(BaseModel):
    ...
    description = models.TextField(blank=True, verbose_name=_("Description"))
    date_awarded = models.DateField(default=timezone.localdate, verbose_name=_("Date Awarded"))
...
class ClassTeacher(BaseModel):
    ...
    start_date = models.DateField(default=timezone.localdate, verbose_name=_("Start Date"))
