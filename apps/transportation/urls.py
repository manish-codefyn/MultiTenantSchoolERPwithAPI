...
urlpatterns = [
    ...
    path('attendance/', include([
        ...
        path('qr/', login_required(views.TransportQRCodeAttendanceView.as_view()), name='attendance_qr'),
        path('face/', login_required(views.TransportFaceAttendanceView.as_view()), name='attendance_face'),
        path('api/verify-face/', views.verify_transport_face_attendance, name='api_verify_face'),
        path('<uuid:pk>/', include([
