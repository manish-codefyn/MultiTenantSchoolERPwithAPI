...
class TransportAllocation(BaseModel, TenantAwareModel):
    ...
    # Allocation Dates
    allocation_date = models.DateField(default=timezone.localdate, verbose_name=_("Allocation Date"))
...
class MaintenanceRecord(BaseModel, TenantAwareModel):
    ...
    maintenance_date = models.DateField(default=timezone.localdate, verbose_name=_("Maintenance Date"))
