...
class TrainingProgramAdmin(admin.ModelAdmin):
    list_display = ("title", "training_type", "start_date", "is_active")
    list_filter = ("training_type", "is_active")

@admin.register(DisciplinaryAction)
class DisciplinaryActionAdmin(admin.ModelAdmin):
    list_display = ("staff", "action_type", "action_date", "is_resolved")
    list_filter = ("action_type", "is_resolved")
    search_fields = ("staff__full_name", "staff__employee_id")

@admin.register(Asset)
class AssetAdmin(admin.ModelAdmin):
    list_display = ("asset_id", "name", "asset_type", "current_status")
    list_filter = ("asset_type", "current_status")
    search_fields = ("name", "asset_id", "serial_number")

@admin.register(AssetAssignment)
class AssetAssignmentAdmin(admin.ModelAdmin):
    list_display = ("asset", "staff", "assigned_date", "expected_return_date", "is_active")
    list_filter = ("is_active", "assigned_date")
    search_fields = ("asset__name", "staff__full_name")
